...
| DeveloperMozilla     | https://developer.mozilla.org/en-US/observatory/ | Read headers and scan for those that are missing.  |
| Security headers     | https://securityheaders.com/ | Read headers for the scan  |
